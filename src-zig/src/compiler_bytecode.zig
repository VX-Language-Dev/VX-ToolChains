...
pub const CompiledModule = struct {
    ...
    structs: std.ArrayList(struct { name: []const u8, fields: std.ArrayList([]const u8) }),
    classes: std.ArrayList(struct { name: []const u8, fields: std.ArrayList([]const u8) }),
